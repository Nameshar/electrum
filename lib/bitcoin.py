...
mnemonic_hash = lambda x: hmac_sha_512("Protoshares mnemonic", x).encode('hex')
...
# Protoshares uses addrtype of 56
...
def SecretToASecret(secret, compressed=False, addrtype=56):
    vchIn = chr((addrtype+128)&255) + secret
    if compressed: vchIn += '\01'
    return EncodeBase58Check(vchIn)

def ASecretToSecret(key, addrtype=56):
